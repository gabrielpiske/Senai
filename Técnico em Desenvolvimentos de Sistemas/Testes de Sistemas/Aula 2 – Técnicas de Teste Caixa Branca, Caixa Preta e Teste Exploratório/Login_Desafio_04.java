...
public class Login_Desafio_04 {
    private static HashMap<String, String> usuarios = new HashMap<>();

    public static void main(String[] args) {
        JFrame frame = new JFrame("Desafio de Teste - Versão 04");
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (senhaSalva.equals(senha)) {
                        lblMensagem.setText("Login realizado.");
                    } else {
                        lblMensagem.setText("Senha incorreta.");
                    }
                } catch (Exception ex) {
                    lblMensagem.setText("Erro: " + ex.toString());
                }
            }
        });
