...
public class Login_Desafio_03 {
    private static HashMap<String, String> usuarios = new HashMap<>();

    public static void main(String[] args) {
        JFrame frame = new JFrame("Desafio de Teste - Versão 03");
        ...
        btnLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (usuarios.containsKey(usuario) && usuarios.get(usuario) == senha) {
                    lblMensagem.setText("Login OK!");
                } else {
                    lblMensagem.setText("Login falhou.");
                }
            }
        });
