...
public class SistemaBibliotecaEmprestimos {
    ...
    public static void realizarEmprestimoGUI() {
        ...
        try {
            ...
            List<String> titulosSelecionados = listaLivros.getSelectedValuesList();
            if (titulosSelecionados.isEmpty()) titulosSelecionados = List.of((String) null);
            for (String titulo : titulosSelecionados) {
